...
global subgoals_from_start_side_to_mining_side.append(ARENA_WIDTH/2, OBSTACLE_BOUNDARY_LOCATION-1, 90 ]) # [x, y, theta]
global mining_area_goal = [ARENA_WIDTH/2, MINING_BOUNDARY_LOCATION+2, 90]
...
def goTo(x,y,theta):
	...
	if(theta!=null):			###seb modification
...
def first_time_go_to_mining_area():
	...
	while(max_counter<6 and current_y<MINING_BOUNDARY_LOCATION+0.5):
		...
		if(moved == False):
			goTo(current_x, current_y+1, null)

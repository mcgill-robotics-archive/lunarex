...
class corner_detectorRequest(genpy.Message):
  _md5sum = "d2e30e729c56e1e73fad43e585bf241a"
...
bool data
"""
  __slots__ = ['map_meta','map','cached']
  _slot_types = ['nav_msgs/MapMetaData','nav_msgs/OccupancyGrid','std_msgs/Bool']
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(_struct_B.pack(self.cached.data))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.cached.data,) = _struct_B.unpack(str[start:end])
      self.cached.data = bool(self.cached.data)
      return self
...
class corner_detector(object):
  ...
  _md5sum = '46dc5a3ad18ff6f87ae0f778ed9484ad'

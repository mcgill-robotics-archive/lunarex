...
class mapBuilder:
	...
	self.insertValueInOccupancyGrid(795, 927,100)
	self.insertValueInOccupancyGrid(1168, 1234,100)
	self.insertValueInOccupancyGrid(2035, 2101,100)
	self.insertValueInOccupancyGrid(2408, 2408,100)

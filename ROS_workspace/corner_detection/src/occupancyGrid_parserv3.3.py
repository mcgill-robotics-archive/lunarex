...
import numpy as np
import roslib; roslib.load_manifest('corner_detection')
import math
import struct
...
#STARTING THE NODE & SUBSCRIBING
rospy.init_node('corner_detection_server', anonymous=True)
s = rospy.Service('corner_detection')

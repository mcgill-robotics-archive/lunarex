...
when floor apears too high, increase (positively) the tilt_x_axis variable
"""
import freenect
import cv
...
height_of_kinect =66 # cm
Xmid = width/2

Zmid = height/2
 
tilt_x_axis =0#0.03 #math.pi/18 # in rads, tilt towards the ground is positive, straight ahead is 0 rad 

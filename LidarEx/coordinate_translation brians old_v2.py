...
def arena2global(arenaCoords, LR_corner, RR_corner, LF_corner, RF_corner, resolution):
  ...
  #corner1 must be the bottom left point #LR_corner
  #corner2 "bottom right" #RR_corner
  #corner3 "top right" #RF_corner
  #corner4 "top left" #LF_corner
  ...
  x2ComponentDir = 1
  y2ComponentDir = 1
  if(LF_corner[0] - LR_corner[0] < 0):
    x2ComponentDir = -1
  if(LF_corner[1] - LR_corner[1] < 0):
    y2ComponentDir = -1
